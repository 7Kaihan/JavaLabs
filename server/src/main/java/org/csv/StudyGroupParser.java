...
import org.exceptions.InvalidNumberException;
import org.modules.*;
...
public class StudyGroupParser {
     ...
     */
    public StudyGroup objectParse(String object) throws  InvalidDataException {
         ...
         * StudyGroup parsing
         */
        studyGroup = studyGroupParser(dt.get(0), dt.get(1), coordinates, zonedDateTime, dt.get(5), dt.get(6), dt.get(7), dt.get(8), person);
        return studyGroup;
    }
     ...
     * @throws InvalidDataException
     */
    private ZonedDateTime zonedDateTimeParser(String zoneDateTime) throws InvalidDataException {
        try {
            ...
            throw new InvalidDataException(ConsoleColor.RED_BACKGROUND + " Invalid date :(" + ConsoleColor.RESET + "\n");
        }
    }
     ...
     */
    private Person personParser(String name, String weight, String hairColor, String nationality, String locationX, String locationY, String locationName) throws InvalidDataException {

        Location location = null;
        try {
            location = locationParser(locationX, locationY, locationName);
        } catch (InvalidDataException dataParseException) {
            throw new InvalidDataException(dataParseException.getMessage());
        }
        Person person = null;
        try {
     ...
     * @throws InvalidDataException
     */
    private double personWeight(String weight) throws InvalidDataException {
        double pW = 0;
        try {
            pW = Double.parseDouble(weight);
            return pW;
        } catch (NumberFormatException exception) {
            throw new InvalidDataException(ConsoleColor.RED_BACKGROUND + "Invalid Person weight :(" + ConsoleColor.RESET + "\n");
        }
    }
     ...
     */
    private Location locationParser(String locationX, String locationY, String locationName) throws InvalidDataException{
        Location location = null;
        try {
     ...
     * @throws InvalidDataException
     */
    private long locationXParser(String lx1) throws InvalidDataException {
        long lx = 0;
        try {
            lx = Long.parseLong(lx1);
            return lx;
        } catch (NumberFormatException exception) {
            throw new InvalidDataException(ConsoleColor.RED_BACKGROUND + "Invalid location x :(" + ConsoleColor.RESET + "\n");
        }
    }
     ...
     * @throws InvalidDataException
     */
    private double locationYParser(String ly1) throws InvalidDataException {
        double ly = 0;
        try {
            ly = Double.parseDouble(ly1);
            return ly;
        } catch (NumberFormatException exception) {
            throw new InvalidDataException(ConsoleColor.RED_BACKGROUND + "Invalid location y :(" + ConsoleColor.RESET + "\n");
        }
    }
     ...
     * @return StudyGroup object
     */
    private StudyGroup studyGroupParser(String id, String name, Coordinates coordinates, ZonedDateTime zonedDateTime, String studentsCount, String expelledStudents, String formOfEducation, String semester, Person person) throws InvalidDataException {
