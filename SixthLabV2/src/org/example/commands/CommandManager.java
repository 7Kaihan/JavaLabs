...
public class CommandManager {
    ...
    private void addCommand(){
        ...
        commandMap.put("print_descending_group_admin",new PrintDescendingGroupAdminCommand(collectionManager));
        commandMap.put("print_field_unique_form_of_education",new PrintUniqueFormOfEducationCommand(collectionManager));
