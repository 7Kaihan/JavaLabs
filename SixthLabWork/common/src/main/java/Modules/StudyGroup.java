...
public class StudyGroup implements DataValidator, Comparable<StudyGroup>, Serializable {
    ...
    public StudyGroup(String name,Coordinates coordinates,ZonedDateTime creationDate,long studentsCount,
                      long expelledStudents,Person groupAdmin){
        this.name = name;
    ...
    public StudyGroup(String name,Coordinates coordinates,ZonedDateTime creationDate,long studentsCount,
                      long expelledStudents,FormOfEducation formOfEducation,Person groupAdmin){
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = creationDate;
        this.studentsCount = studentsCount;
    ...
    public StudyGroup(String name,Coordinates coordinates,ZonedDateTime creationDate,long studentsCount,
                      long expelledStudents,Semester semesterEnum,Person groupAdmin){
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = creationDate;
        this.studentsCount = studentsCount;
